...
/**
 * Application context Java configuration class. 
 * requires Spring Framework 3.0 
 * @EnableWebMvc annotation requires Spring Framework 3.1</li>
 * 
 * @author itamayo
 */
@Configuration
@ComponentScan(basePackages = {"fr.gipmds.arpej.controller",
        "fr.gipmds.arpej"})
@EnableTransactionManagement
@EnableWebMvc
@ImportResource({"classpath:applicationContext.xml", "classpath:security-context.xml"})
